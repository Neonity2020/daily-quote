...
export type Quote = {
  ...
  sourceUrl?: string;
  provenance: string;
  verification: "external-source" | "editorial-original" | "needs-review";
  date: string;
...
export const quotes: Quote[] = [
  {
    ...
    sourceUrl:
      "https://www.penguinrandomhouse.com/books/314003/the-obstacle-is-the-way-expanded-10th-anniversary-edition-by-ryan-holiday/",
    provenance:
      "书名与核心概念溯源到 Ryan Holiday《The Obstacle Is the Way》。中文为每日金句编辑部译写。",
  ...
  },
  {
    ...
    provenance:
      "每日金句编辑部原创表达，基于管理指标与产品打磨的内部笔记整理。",
    verification: "editorial-original",
    interpretation:
  ...
  },
  {
    ...
    provenance:
      "每日金句编辑部原创表达，基于 AI 辅助工作流与判断力议题整理。",
    verification: "editorial-original",
    interpretation:
  ...
  },
  {
    ...
    provenance:
      "每日金句编辑部原创表达，基于产品承诺、用户信任与 MVP 迭代经验整理。",
    verification: "editorial-original",
    interpretation:
  ...
  },
  {
    ...
    provenance:
      "常见现代英文转述，思想源自《沉思录》的斯多葛控制观；公开发布前建议按选定译本进一步核对原文措辞。",
  ...
  },
  {
    ...
    source: "Business Growth Notes",
    provenance:
      "每日金句编辑部原创表达，基于战略执行、时间分配与资源约束的内部笔记整理。",
    verification: "editorial-original",
    interpretation:
  ...
  },
  {
    ...
    source: "AI Philosophy Notes",
    provenance:
      "每日金句编辑部原创表达，基于 AI 自动化、流程设计与任务定义的内部笔记整理。",
    verification: "editorial-original",
    interpretation:
